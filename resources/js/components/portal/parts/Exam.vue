<template>
	<div>
        ...
        <div class="row" v-if="!has_message">
            <div class="col-sm-12">
                <!-- Start of form -->
        ...
        <div v-if="exams.length < 1">
            <div class="alert alert-info">The examination is not yet available for this step.</div>
        </div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getExams() {
				axios.get(`/api/examination/course/${this.courseID}`, {
						headers: {
