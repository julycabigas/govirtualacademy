		...
		<div class="container">
			<div class="custom-content-area row">
					<div class="col-lg-6">
						...
						<div class="area-form">
							<h1 class="font-weight-bold">Mentor Registration</h1>
							...
							<form @submit.prevent="authenticate">
								...
								<div class="form-group">
									<label for="position" class="sr-only">Positions</label>
									<input type="text" v-model="user.position" placeholder="Positions ( Add / for more multiple positions)">
								</div>
					...
					<div class="col-lg-6">
						<div class="text-block mt-4">
							<h4>Register as a Student or as a Mentor</h4>
							...
							<p style="margin-top: 30px;">
								 <router-link to="/register" class="btn btn-secondary">Register as Student</router-link>
							</p>
						</div>
					</div>
				</div>	
