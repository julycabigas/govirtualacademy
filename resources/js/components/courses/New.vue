	...
	<div class="video-new">
		...
		<form @submit.prevent="add">
			<table class="table">
				...
				<tr>
					<th>Access Level slug (e.g va)</th>
					<td>
				...
				<tr>
					...
					<td>
						<input type="number" name="timer" min="60" max="7200" v-model="course.timer" />
					</td>
				</tr>
				<tr>
					<th>Access Levels</th>
					<td>
						<strong class="label label-info">Untick the rest if you select free course</strong>
